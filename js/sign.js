let navbarBrand=document.querySelector(".container a"),paths=(navbarBrand.innerHTML=`
...
`,document.querySelector(".container .navbar-brand .svg .g path")),len=paths.getTotalLength();paths.style.setProperty("--l",len);